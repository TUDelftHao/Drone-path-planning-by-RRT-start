...
tr=[para.b para.b para.b para.b;0 -para.l*para.b 0 para.l*para.b;-para.l*para.b 0 para.l*para.b 0;-para.d para.d -para.d para.d]; 

omega2=(omega).^2; % 4 by 1 vector
Omega=-omega(1)+omega(2)-omega(3)+omega(4); %Omegad 
u=tr*omega2;  % input u
...
% vphi=vphi+dt*((para.Iy-para.Iz)/para.Ix*vtheta*vpsi+u(2)*para.l/para.Ix);phi=phi+dt*vphi;
% vtheta=vtheta+dt*((para.Iz-para.Ix)/para.Iy*vphi*vpsi+para.Jr*vphi*Omega+u(3)*para.l/para.Iy); theta=theta+dt*vtheta;
% vpsi=vpsi+dt*((para.Ix-para.Iy)/para.Iz*vphi*vtheta+u(4)*1/para.Iz); psi=psi+dt*vpsi;
